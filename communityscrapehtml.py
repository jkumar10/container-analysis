...
COMMUNITY_IMAGE_PATH="D:\malware\community_reports_html"
fwi=open(r"C:\Users\Jainendra\PycharmProjects\malware\reports\community\community_individual_image_stats.txt","w")
fwc=open(r"C:\Users\Jainendra\PycharmProjects\malware\reports\community\community_unique_cve_list.txt","w")
fws=open(r"C:\Users\Jainendra\PycharmProjects\malware\reports\community\community_stats.txt","w")
fwl=open(r"C:\Users\Jainendra\PycharmProjects\malware\reports\community\community_label_cve.txt","w")
print("--------CLASSIFYING VULNERABILITIES IN COMMUNITY IMAGES-------------",file=fwi)
directory = os.fsencode(COMMUNITY_IMAGE_PATH)
os.chdir(COMMUNITY_IMAGE_PATH)
...
print("\n")
print("TOP 11 COMMUNITY IMAGES WITH MOST VULNERABILITIES: ",file=fws)
t=1
